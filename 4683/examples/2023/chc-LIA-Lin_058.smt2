; ./prepared/hcai/./svcomp/O0/sum01_false-unreach-call_true-termination_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Bool) (L Int) (M Int) (N Int) (O Int) ) 
    (=>
      (and
        (main@_bb M E F)
        (let ((a!1 (or (not K) (not (= (<= 10 F) C)))))
