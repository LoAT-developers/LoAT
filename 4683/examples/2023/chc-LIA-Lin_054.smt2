; ./prepared/hcai/./svcomp/O3/Addition01_true-unreach-call_true-no-overflow_true-termination_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Bool) (G Bool) (H Int) (I Int) (J Int) (K Int) (L Int) ) 
    (=>
      (and
        main@entry
        (let ((a!1 (= B (or (not (<= I 1073741823)) (not (>= I 0)))))
      (a!2 (= A (or (not (<= J 1073741823)) (not (>= J 0))))))
  (and a!1
       (= D (= I 0))
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Bool) (K Bool) (L Bool) ) 
    (=>
      (and
        main@entry
        (let ((a!1 (= B (or (not (<= F 1073741823)) (not (>= F 0)))))
      (a!2 (= A (or (not (<= G 1073741823)) (not (>= G 0))))))
  (and a!1
       (= C (= F 0))
       (or (not D) (= E G) (not K))
       (or (not D) (= H E) (not K))
