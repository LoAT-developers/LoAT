; ./prepared/jayhorn/./sv-comp-2020/jbmc-regression/assert6/smt-output-with-inlining/jayhorn-tmp_0_000.smt2
(set-logic HORN)
...
(declare-fun |<Main: void main(JayArray_java_lang_String)>_Block10_5| ( Int Int Int Int Int Int Int Int Int ) Bool)
(declare-fun |<Main: void main(JayArray_java_lang_String)>_Block10| ( Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int ) Bool)
(declare-fun |<Main: void main(JayArray_java_lang_String)>_Block10_6| ( Int Int Int Int Int Int Int Int Int Int ) Bool)
...
(declare-fun |<Main: void main(JayArray_java_lang_String)>_Block10_7| ( Int Int Int Int Int Int Int Int Int Int ) Bool)
...
(declare-fun |<Main: void main(JayArray_java_lang_String)>_Block10_4| ( Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int ) Bool)
(declare-fun |<Main: void main(JayArray_java_lang_String)>_Block10_8| ( Int Int Int Int Int Int Int Int Int Int Int ) Bool)
(declare-fun |<Main: void main(JayArray_java_lang_String)>_pre| ( Int Int Int Int Int ) Bool)
(declare-fun |<Main: void main(JayArray_java_lang_String)>_Block10_9| ( Int Int Int Int Int Int Int Int Int Int ) Bool)
...
(assert
  ...
  L)
     ...
     (= v_23 H))
      ...
      (|<Main: void main(JayArray_java_lang_String)>_Block10_4|
  N
  B
  P
  H
...
(assert
  ...
  A)
      ...
      (|<Main: void main(JayArray_java_lang_String)>_Block10_5| G E D F J L I M C)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (|<Main: void main(JayArray_java_lang_String)>_Block10_5| C H J F I E B A G)
        true
      )
      (|<Main: void main(JayArray_java_lang_String)>_Block10_6| C H J F I E B A D G)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (|<Main: void main(JayArray_java_lang_String)>_Block10_6| A G I F C J B E D H)
        (and (<= D 2147483647) (<= (- 2147483648) D))
      )
      (|<Main: void main(JayArray_java_lang_String)>_Block10_7| A G I F C J B E D H)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (|<Main: void main(JayArray_java_lang_String)>_Block10_7| A J H D B G E F K C)
        (= I 0)
      )
      (|<Main: void main(JayArray_java_lang_String)>_Block10_8| A J H D B I G E F K C)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (|<Main: void main(JayArray_java_lang_String)>_Block10_8| E C J F B K I H A D G)
        true
      )
      (|<Main: void main(JayArray_java_lang_String)>_Block10_9| E C J F B I H A D G)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      (and
        (|<Main: void main(JayArray_java_lang_String)>_Block10_8| H A F I K G D J C E B)
        (not (= G 0))
      )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (|<Main: void main(JayArray_java_lang_String)>_Block10_9| F E G H B J D A I C)
        (not (<= I 999))
      )
