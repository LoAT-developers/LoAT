; ./prepared/vmt/./ctigar/barbr.c_000.smt2
(set-logic HORN)
  ...
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Bool) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) ) 
    (=>
      (and
        ...
        (and (not C)
     (= A true)
     (or (and (not B) D E (not F) G H)
         (and (not B) D E F (not G) (not H))
         (and (not B) D E F (not G) H)
         (and (not B) D E F G (not H))
         (and (not B) D E F G H)
         (and B (not D) (not E) (not F) (not G) (not H))
         (and B (not D) (not E) (not F) (not G) H)
         (and B (not D) (not E) (not F) G (not H))
         (and B (not D) (not E) (not F) G H)
         (and B (not D) (not E) F (not G) (not H))
         (and B (not D) (not E) F (not G) H)
         (and B (not D) (not E) F G (not H))
         (and B (not D) (not E) F G H)))
      )
      false
    )
  )
