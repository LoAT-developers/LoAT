; ./vmt/./lustre/fast_1_e7_2044_e7_1287_000.smt2
(set-logic HORN)
...
(assert
      ...
      (and
       ...
       N)
        (let ((a!1 (= (or (and (not C1) (not L4) M4)
              ...
              N4))
      (a!2 (= J2 (or I2 (not R4) (and (not I2) R4))))
      (a!3 (or (not K4) (and (not Y1) (not X1) (or (not S) (not Z1)))))
      (a!4 (= (or (and (not F3) (not D3) B3)
  ...
  (and a!1
       ...
       (= B L1)
       (= A K1)
       (or Y1 X1 (= K4 J4) (and S Z1))
       (or H2 (not D2) (not S3))
       (or (not G4) (not F4) (= Q3 E4))
       (or (= U1 A1) (not V1) (not W1))
       (or D1 (not Q4) (not E1))
       (or S J4 (not B2))
       (or (= H2 C2) (and S3 D2))
       (or (= D1 P4) (and E1 Q4))
       (or (= S J4) (and (not S) B2))
       (or (not D2) (= U C2))
       (or D2 (not C2))
       (or (not F3) (= R3 Q3))
