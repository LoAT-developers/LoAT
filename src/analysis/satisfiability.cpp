...
void Satisfiability::store_step(const TransIdx idx, const BoolExpr &implicant) {
...
bool Satisfiability::try_queries(const std::vector<TransIdx> &queries) {
...
bool Satisfiability::try_queries() {
