...
namespace Config {
    ...
    namespace Analysis {
        ...
        std::vector<Mode> modes { Complexity, RankingFunction, NonTermination, Acceleration, RecurrentSet, Smt2Export, CheckUniformity };
        ...
        std::string modeName(const Mode mode) {
            ...
            case CIntExport: return "c_int_export";
                break;
            case CheckUniformity: return "check_uniformity";
                break;
            default:
